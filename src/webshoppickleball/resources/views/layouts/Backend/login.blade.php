<html lang="en">
    <head>
        ...
        <!-- Styles -->
        <link rel="stylesheet" href="/Backend/assets/auth/css/app.css">

        <!-- Scripts -->
        <script src="/Backend/assets/auth/js/app.js" defer=""></script>
    </head>
    <body>
        <div class="font-sans text-gray-900 antialiased">
            <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
                ...
                <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                    <input type="hidden" name="_token" value="DbxoBicrL56YF4crCgOvWHFFC91BbhGAmiMcg9Mw"><div>
                        ...
                        <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block mt-1 w-full"
                            id="username" type="text" name="username" value="" required="required"  autofocus="autofocus">
                    </div>
                    ...
                    <div class="block mt-4">
                        <label for="remember_me" class="flex items-center">
                            ...
                            <span class="ml-2 text-sm text-gray-600">Nhớ tài khoản</span>
                        </label>
                    </div>

                    <div class="flex items-center justify-end mt-4">
                        <button id = "btn_login" type="button" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition ml-4">
                            Đăng nhập
                        </button>
                    </div>
                </div>
    ...
    <script src="/Backend/assets/js/pages/login.js"></script>
</html> 