    ...
    <ul class="menu-nav">
                ...
                <ul class="menu-subnav">
                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        <a href="/admin/manage" href="javascript:;" class="menu-link menu-toggle">
                            ...
                            <span class="menu-text">Danh sách quản trị viên</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="menu-subnav">
                    ...
                    <li class="menu-item" aria-haspopup="true">
                        <a href="/admin/category" class="menu-link">
                            ...
                            <span class="menu-text">Danh sánh danh mục</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <ul class="menu-subnav">
                    ...
                    <li class="menu-item" aria-haspopup="true">
                        <a href="/admin/discount" class="menu-link">
                            ...
                            <span class="menu-text">Danh sánh ưu đãi</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
            <a href="javascript:;" class="menu-link menu-toggle">
                ...
                <span class="menu-text">Báo cáo doanh thu</span>
                <i class="menu-arrow"></i>
            </a>
            <div class="menu-submenu">
                <i class="menu-arrow"></i>
