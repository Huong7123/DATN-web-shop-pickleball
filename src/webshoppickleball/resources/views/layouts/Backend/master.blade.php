...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="/Backend/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="/Backend/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
		<link href="/Backend/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
		<link href="/Backend/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="/Backend/assets/media/logos/logo-light.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
						<a href="/admin/dashboard" class="brand-logo" style="font-size: 18px;text-transform: uppercase;color: white !important;position: relative">
							<img alt="Logo" src="https://taichinh-v2.hqwg.pro/assets/backend/themes/media/logos/logo-light.png" />
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                        @include('layouts.Backend.widget.__aside_menu')
					</div>
					<!--end::Aside Menu-->
				</div>
				<!--end::Aside-->
