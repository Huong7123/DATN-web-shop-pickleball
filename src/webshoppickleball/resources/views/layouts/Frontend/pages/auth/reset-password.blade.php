                ...
                <div>
                    ...
                    <fieldset class="relative flex justify-center gap-2 sm:gap-4">
                        <input
                            ...
                            onkeydown="(event.key=='Backspace' && this.value==='' && this.previousSibling && ((this.previousSibling.value=''),this.previousSibling.focus())) || (event.key==='ArrowLeft' && this.previousSibling && this.previousSibling.focus()) || (event.key==='ArrowRight' && this.nextSibling && this.nextSibling.focus());"
                            onkeyup="event.key.match(/^\d$/) && ((this.value.length>1 && (this.nextSibling && (this.nextSibling.value=this.value.slice(1)), this.value=this.value[0])), (this.nextSibling && this.nextSibling.focus()));"
                            type="number" value="" />
                        <input
                            class="flex h-14 w-12 text-center text-lg font-bold [appearance:textfield] focus:outline-0 focus:ring-2 focus:ring-primary/50 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none rounded-lg border border-gray-300 dark:border-gray-600 bg-background-light dark:bg-gray-800"
                            max="9" maxlength="1" min="0"
