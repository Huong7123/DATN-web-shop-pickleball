...
<div
    ...
    <div
        ...
        <button
            ...
            <span id="btn_close_modal" class="material-symbols-outlined">close</span>
        </button>
    </div>
    <!-- Scrollable Body -->
    ...
    <div
        ...
        <button id="btn_close_modal"
            class="px-6 py-2.5 rounded-lg border border-border-light dark:border-border-dark text-text-light dark:text-text-dark font-semibold text-sm hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
            Hủy bỏ
        </button>
