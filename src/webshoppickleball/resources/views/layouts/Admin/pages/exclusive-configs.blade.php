...
<div class="flex-1 overflow-y-auto p-8 max-w-[1200px] mx-auto w-full">
    ...
    <div class="flex flex-col gap-4">
        ...
        <div
            class="group flex flex-col md:flex-row items-center gap-6 p-6 rounded-2xl bg-white dark:bg-[#152a1c] border border-[#cfe7d7] dark:border-[#2d4a35] transition-all hover:border-primary/50 hover:shadow-xl">
            <div
                class="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#C0C0C0]/20 text-[#8e8e8e]">
                <span class="material-symbols-outlined text-4xl font-bold">workspace_premium</span>
            </div>
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-3 mb-1">
                    <h4 class="text-xl font-extrabold truncate">Hạng Bạc (Silver)</h4>
                </div>
                <p class="text-[#4c9a66] text-sm font-medium mb-3">Chi tiêu tối thiểu: <span
                        class="text-primary font-black">5.000.000 VNĐ</span></p>
                <div class="flex flex-wrap gap-2">
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-[#f0f9f3] dark:bg-[#1a3321] text-[#4c9a66] dark:text-primary text-xs font-semibold border border-primary/20">
                        <span class="material-symbols-outlined text-sm">local_shipping</span> Miễn phí ship
                    ...
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-[#f0f9f3] dark:bg-[#1a3321] text-[#4c9a66] dark:text-primary text-xs font-semibold border border-primary/20">
                        <span class="material-symbols-outlined text-sm">percent</span> Voucher 10%
                    </span>
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-[#f0f9f3] dark:bg-[#1a3321] text-[#4c9a66] dark:text-primary text-xs font-semibold border border-primary/20">
                        <span class="material-symbols-outlined text-sm">cake</span> Quà sinh nhật
                    </span>
                </div>
            </div>
            <div class="flex items-center gap-4 ml-auto">
        ...
        <!-- Tier 3: Gold -->
        <div
            class="group flex flex-col md:flex-row items-center gap-6 p-6 rounded-2xl bg-white dark:bg-[#152a1c] border border-primary/40 dark:border-primary/40 shadow-lg shadow-primary/5 transition-all hover:shadow-2xl">
            <div
                class="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#FFD700]/20 text-[#DAA520]">
                <span class="material-symbols-outlined text-4xl font-bold">stars</span>
            </div>
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-3 mb-1">
                    <h4 class="text-xl font-extrabold truncate">Hạng Vàng (Gold)</h4>
                    <span
                        class="px-2 py-0.5 rounded text-[10px] font-bold bg-primary text-background-dark uppercase">Phổ
                        biến nhất</span>
                </div>
                <p class="text-[#4c9a66] text-sm font-medium mb-3">Chi tiêu tối thiểu: <span
                        class="text-primary font-black">15.000.000 VNĐ</span></p>
                <div class="flex flex-wrap gap-2">
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-primary/20 text-[#0d1b12] dark:text-primary text-xs font-bold border border-primary/50">
                        <span class="material-symbols-outlined text-sm">percent</span> Voucher 15%
                    </span>
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-primary/20 text-[#0d1b12] dark:text-primary text-xs font-bold border border-primary/50">
                        <span class="material-symbols-outlined text-sm">priority_high</span> Ưu tiên đặt sân
                    </span>
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-primary/20 text-[#0d1b12] dark:text-primary text-xs font-bold border border-primary/50">
                        <span class="material-symbols-outlined text-sm">new_releases</span> Sớm trải nghiệm
                        vợt mới
                    </span>
                    <span
                        class="flex items-center gap-1 px-3 py-1 rounded-full bg-primary/20 text-[#0d1b12] dark:text-primary text-xs font-bold border border-primary/50 text-primary-dark">
                        +2 Ưu đãi khác
                    </span>
                </div>
            </div>
            <div class="flex items-center gap-4 ml-auto">
                ...
                <div class="flex gap-2">
                    <button
                        class="p-3 rounded-xl bg-primary text-background-dark hover:bg-primary/80 transition-colors">
        ...
        <!-- Tier 4: Platinum (Paused State) -->
        <div
            class="group flex flex-col md:flex-row items-center gap-6 p-6 rounded-2xl bg-white/50 dark:bg-[#152a1c]/50 border border-dashed border-[#cfe7d7] dark:border-[#2d4a35] transition-all opacity-80">
            <div
                class="flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-200 dark:bg-gray-800 text-gray-500">
                <span class="material-symbols-outlined text-4xl font-bold">diamond</span>
            </div>
            <div class="flex-1 min-w-0">
                <div class="flex items-center gap-3 mb-1">
                    <h4 class="text-xl font-extrabold truncate text-gray-500">Bạch Kim (Platinum)</h4>
                    <span
                        class="px-2 py-0.5 rounded text-[10px] font-bold bg-gray-200 text-gray-600 uppercase">Tạm
                        dừng</span>
                </div>
                <p class="text-gray-400 text-sm font-medium mb-3">Chi tiêu tối thiểu: <span
                        class="font-bold">50.000.000 VNĐ</span></p>
                <div class="flex flex-wrap gap-2">
                    <span
                        class="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-400 text-xs font-semibold">Tất
                        cả đặc quyền Vàng</span>
                    <span
                        class="px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-400 text-xs font-semibold">Hoàn
                        tiền 5%</span>
                </div>
            </div>
            <div class="flex items-center gap-4 ml-auto">
                <div class="flex flex-col items-end mr-4">
                    <span class="text-xs font-bold text-gray-400 mb-1">TRẠNG THÁI</span>
                    <div class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="flex gap-2">
                    <button class="p-3 rounded-xl bg-gray-100 dark:bg-gray-800">
                        <span class="material-symbols-outlined text-gray-400">edit</span>
                    </button>
                    <button class="p-3 rounded-xl bg-gray-100 dark:bg-gray-800">
                        <span class="material-symbols-outlined text-red-300">delete</span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <!-- Footer Support -->
    <div
        class="mt-12 p-6 rounded-2xl bg-primary/10 border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            <div class="p-2 bg-primary rounded-lg text-background-dark">
                <span class="material-symbols-outlined">help_center</span>
            </div>
            <div>
                <p class="font-bold text-[#0d1b12] dark:text-white">Cần hỗ trợ cấu hình?</p>
                <p class="text-sm text-[#4c9a66]">Xem tài liệu hướng dẫn vận hành hệ thống khách hàng thân
                    thiết.</p>
            </div>
        </div>
        <button
            class="px-4 py-2 text-sm font-bold border-2 border-primary text-background-dark bg-primary rounded-lg">Xem
            hướng dẫn</button>
    </div>
</div>
