    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            res.data.data.forEach(category => {
                ...
                const lockBtn = category.status == 1
                    ? `<button class="btn btn-danger btn-sm btn-lock" data-id="${category.id}" data-status="0">
                            <i class="fa fa-lock p-0"></i>
                       </button>`
                    : `<button class="btn btn-success btn-sm btn-lock" data-id="${category.id}" data-status="1">
