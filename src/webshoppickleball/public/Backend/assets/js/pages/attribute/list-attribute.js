            ...
            res.data.data.forEach(attribute => {
                ...
                tbody.append(`
                    <tr>
                        ...
                        <td>${attribute.status == 1 ? '<span class="label label-success" style="width:100px;height:24px;border-radius:6px">Hoạt động</span>' : '<span class="label label-danger" style="width:100px;height:24px;border-radius:6px">Chưa kích hoạt</span>'}</td>
                        <td>${createdAt}</td>
                        <td>${updatedAt}</td>
